...
# Send request and summarize open orders
curl -s -H "X-MBX-APIKEY: $API_KEY" -X GET "$BASE_URL$ENDPOINT?$QUERY_STRING&signature=$SIGNATURE" | jq '[.[] | {symbol, side, price, origQty, status}]'